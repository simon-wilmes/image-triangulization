...
parser.add_argument("number_of_points", help="The number of points that will be created.")
...
# Parse parameters
IMG_INPUT = args.input_img
MASK_INPUT = args.mask_img
USE_MASK = (args.mask_img is not None)
MASK_FACTOR = args.mask_strength
MASK_TRUE_VALUE = 0
IMG_FOLDER = args.output_folder
IMG_TYPE = IMG_INPUT.rsplit(".",1)[1]
NUM_POINTS = args.number_of_points
DISTANCE_BETWEEN_POINTS = args.distance_points
...
class Triangulizer:
    def __init__(self, args):
        self.IMG_INPUT = args.input_img
        self.MASK_INPUT = args.mask_img
        ...
        self.IMG_TYPE = IMG_INPUT.rsplit(".",1)[1]
        self.NUM_POINTS = args.number_of_points
        self.DISTANCE_BETWEEN_POINTS = args.distance_points
        self.FOLDER = args.output_folder
        # Create output folder if not exists
        try:
            os.mkdir(self.FOLDER)
        self.output_path = Path(self.FOLDER)
